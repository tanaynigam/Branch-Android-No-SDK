...
public class MonsterViewerActivity extends FragmentActivity implements InfoFragment.OnFragmentInteractionListener {
    ...
    private void initUI() {
        ...
        new BranchEvent("monster_view")
                .addCustomDataProperty("$monsterview", myMonsterObject.monsterMetaData().toString())
                .logEvent(MonsterViewerActivity.this);


        BranchUniversalObject buo = new BranchUniversalObject()
                .setCanonicalIdentifier("monsterActivity")
                .setTitle("SharedMonster")
                .setContentDescription("My shared monster")
        ...
        LinkProperties lp = new LinkProperties()
                .setChannel("Hangouts")
                .setFeature("sharing")
                .setCampaign("Branch Assessment")
                .setStage("Tanay Nigam")
                .addControlParameter(MonsterPreferences.KEY_BODY_INDEX, myMonsterObject.prepareBranchDict()
                        .get(MonsterPreferences.KEY_BODY_INDEX))
                .addControlParameter(MonsterPreferences.KEY_COLOR_INDEX, myMonsterObject.prepareBranchDict()
                        .get(MonsterPreferences.KEY_COLOR_INDEX))
                .addControlParameter(MonsterPreferences.KEY_FACE_INDEX, myMonsterObject.prepareBranchDict()
                        .get(MonsterPreferences.KEY_FACE_INDEX))
                .addControlParameter(MonsterPreferences.KEY_MONSTER_NAME, myMonsterObject.prepareBranchDict()
                        .get(MonsterPreferences.KEY_MONSTER_NAME))
                .addControlParameter(MonsterPreferences.KEY_MONSTER_IMAGE, myMonsterObject.prepareBranchDict()
                        .get(MonsterPreferences.KEY_MONSTER_IMAGE))
                .addControlParameter(MonsterPreferences.KEY_MONSTER_DESCRIPTION, myMonsterObject.prepareBranchDict()
                        .get(MonsterPreferences.KEY_MONSTER_DESCRIPTION));
